											...
											<div class="col-xl-3">
												...
												<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(https://income.bti.ps/assets/media/svg/shapes/abstract-1.svg)">
													...
													<div class="card-body">
														...
														<p class="text-dark-75 font-weight-boldest  m-0" style="font-size: 40px !important;">${{number_format($profit->SumNeg) ?? "0"}}</p>
													</div>
													<!--end::Body-->
												</div>
												<!--end::Stats Widget 3-->
											...
											<div class="col-xl-4">
												...
												<div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url(https://income.bti.ps/assets/media/svg/shapes/abstract-2.svg)">
													...
													<div class="card-body">
														...
														<p class="text-dark-75 font-weight-boldest  m-0" style="font-size: 40px !important;">{{number_format($profit->trades) ?? "0"}}</p>
													</div>
													<!--end::Body-->
												</div>
												<!--end::Stats Widget 2-->
...
{{-- 
		...
		<script>
			...
			const ctx7 = document.getElementById('myChart8').getContext('2d');
			const ctx8 = document.getElementById('myChart9').getContext('2d');
			const ctx9 = document.getElementById('myChart10').getContext('2d');
		 ...
		 const data8 = {
			...
			var myChart8 = createChart(ctx7,type[0], data8)
			var myChart9 = createChart(ctx8,type[0], data9)
			var myChart10 = createChart(ctx9,type[0], data10)
